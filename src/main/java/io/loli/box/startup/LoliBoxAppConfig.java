...
public class LoliBoxAppConfig extends ResourceConfig {
    ...
    public LoliBoxAppConfig() {
        ...
        register(JspMvcFeature.class).property(JspMvcFeature.TEMPLATES_BASE_PATH, "/WEB-INF/jsp").property(
            ServletProperties.FILTER_STATIC_CONTENT_REGEX, "/static/.*(js|css|swf|ico|png)(\\?.*)*");
