...
import io.loli.box.startup.GrizzlyBaseTest;
...
public class ImageActionTest extends GrizzlyBaseTest {
    ...
    public void testUpload() {
        ...
        final Response response = client.target(new LoliBoxConfig().getUrl()).path("image/upload")
